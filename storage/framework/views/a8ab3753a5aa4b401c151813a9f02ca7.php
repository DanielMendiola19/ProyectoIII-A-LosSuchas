...
<body>
  ...
  <div class="error-container">
    ...
    <h2 class="fw-semibold"><?php echo $__env->yieldContent('title'); ?></h2>
    <p class="error-message"><?php echo $__env->yieldContent('message'); ?></p>
    <a href="<?php echo e(url('/dashboard')); ?>" class="btn-dashboard">Volver al Dashboard</a>
  </div>
</body>
</html>
<?php /**PATH C:\laragon\www\ProyectoIII-A-LosSuchas\resources\views/layouts/error-layout.blade.php ENDPATH**/ ?>